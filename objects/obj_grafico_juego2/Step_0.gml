...
if (total > 0) {
    ...
    with (obj_receptor2) {if (estado == 0) estado_0 += 1;  }
	with (obj_receptor2) {if (estado == 1) estado_1 += 1;  }
	with (obj_receptor2) {if (estado == 2) estado_2 += 1;  }
