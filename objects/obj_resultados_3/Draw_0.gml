...
if (obj_checkbox_kinasa.chequeado) {
...
for (var i = 0; i < ds_list_size(coordenadas); i++) {
	...
	if (e ==0){ draw_set_color(c_blue);  }
	if (e ==1){ draw_set_color(#1D1DEE);  }
	if (e ==2){ draw_set_color(#1C39C9);  }
	if (e ==3){ draw_set_color(#194BAE);  }
	if (e ==4){ draw_set_color(#1165A5);  }
	if (e ==5){ draw_set_color(#165E87);  }
	if (e ==6){ draw_set_color(#178297);  }
	if (e ==7){ draw_set_color(#17978E);  }
	if (e ==8){ draw_set_color(#179760);  }
	if (e ==9){ draw_set_color(#0A7A4A);  }
...
if (obj_checkbox_fosfatasa.chequeado) {
...
for (var i = 0; i < ds_list_size(coordenadas_1); i++) {
	...
	if (e ==0){ draw_set_color(c_yellow);  }
	if (e ==1){ draw_set_color(#CFE506);  }
	if (e ==2){ draw_set_color(#B1C404);  }
	if (e ==3){ draw_set_color(#C4B704);  }
	if (e ==4){ draw_set_color(#C4A404);  }
	if (e ==5){ draw_set_color(#AE9413);  }
	if (e ==6){ draw_set_color(#AB7F07);  }
	if (e ==7){ draw_set_color(#F28B04);  }
	if (e ==8){ draw_set_color(#F25B04);  }
	if (e ==9){ draw_set_color(#F23404);  }
...
if (obj_checkbox_Actividad.chequeado) {
...
for (var i = 0; i < ds_list_size(coordenadas_2); i++) {
	...
	if (e ==0){ draw_set_color(c_fuchsia);  }
	if (e ==1){ draw_set_color(#7B04F2);  }
	if (e ==2){ draw_set_color(#9905E4);  }
	if (e ==3){ draw_set_color(#C605E4);  }
	if (e ==4){ draw_set_color(#E405E4);  }
	if (e ==5){ draw_set_color(#202020);  }
	if (e ==6){ draw_set_color(#606060);  }
	if (e ==7){ draw_set_color(#808080);  }
	if (e ==8){ draw_set_color(#FF66B2);  }
	if (e ==9){ draw_set_color(#CC99FF);  }
